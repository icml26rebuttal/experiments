...
Experimental results for the rebuttal of the paper "Ain't no frequency high (low) enough: adversarial robustness through the lens of structured transforms". The folder **Transferability** contains 2 scripts: 
...
Auxiliary files called by ``eval_transferability.py`` and ``eval_transferability_cifar100.py``:
