...
def save_results(results: Dict, args):
    ...
    json_file = os.path.join(args.output_dir, f'{args.case}_transferability_cifar100_detailed.json')
    serializable = {
        source: {
    ...
    stats_file = os.path.join(args.output_dir, f'{args.case}_transferability_cifar100_stats.txt')
    ...
    asr_csv = os.path.join(args.output_dir, f'{args.case}_transferability_cifar100_asr.csv')
    ...
    acc_csv = os.path.join(args.output_dir, f'{args.case}_transferability_cifar100_accuracy.csv')
    ...
    if args.save_heatmaps:
        ...
        asr_heatmap = os.path.join(args.output_dir, 
                                   f'{args.case}_transferability_asr_cifar100_heatmap.png')
        ...
        acc_heatmap = os.path.join(args.output_dir,
                                   f'{args.case}_transferability_accuracy_cifar100_heatmap.png')
        plot_transferability_heatmap(
